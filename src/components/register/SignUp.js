        ...
        <Card.Body className="container-item formContent">
          ...
          <Form onSubmit={handleSubmit}
            ...
            <Form.Group className="form-item">
              ...
              <Form.Control className="input-item" placeholder="Email address" type="email" ref={emailRef} required />
            </Form.Group>

            <Form.Group className="form-item">
              <Form.Label className="label-item">Password:</Form.Label>
              <Form.Control className="input-item" placeholder="Password" type="password" ref={passwordRef} required />
            </Form.Group>

            <Form.Group className="form-item">
              <Form.Label className="label-item">Password confirm:</Form.Label>
              <Form.Control className="input-item" placeholder="Password confirm" type="password" ref={passwordConfirmRef} required />
            </Form.Group>
